...
class JointToBone:
    ...
    def __init__(self, dataset='nturgb+d', target='keypoint'):
        ...
        self.target = target
        if self.dataset not in ['nturgb+d', 'openpose', 'coco', 'face68']:
            raise ValueError(
        ...
        elif self.dataset == 'face68':
            self.pairs = [
                (8, 7), (7, 6), (6, 5), (5, 4), (4, 3), (3, 2), (2, 1), (1, 0), (0, 30),
                (8, 9), (9, 10), (10, 11), (11, 12), (12, 13), (13, 14), (14, 15), (15, 16), (16, 30),
                (17, 18), (18, 19), (19, 20), (20, 21), (17, 36), (36, 37), (37, 38), (38, 39), (39, 40), (40, 41),
                (41, 36), (17, 27),
                (26, 25), (25, 24), (24, 23), (23, 22), (26, 45), (45, 44), (44, 43), (43, 42), (42, 47), (47, 46),
                (46, 45), (26, 27),
                (27, 28), (28, 29), (29, 30), (30, 33), (33, 32), (32, 31), (33, 34), (34, 35),
                (60, 61), (61, 62), (62, 63), (63, 64), (64, 65), (65, 66), (66, 67), (67, 60), (60, 48), (64, 54),
...
class ToMotion:
    ...
    def __call__(self, results):
        ...
        if C == 3 and self.dataset in ['openpose', 'coco', 'face68']:
